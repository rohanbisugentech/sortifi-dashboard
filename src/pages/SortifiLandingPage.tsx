  ...
  useEffect(() => {
    let ctx = gsap.context(() => {
      ...
      gsap.to('#solution-card', {
        scrollTrigger: { trigger: '#solution-card', start: 'top 90%' },
      ...
      gsap.utils.toArray('.fgm-item').forEach((el, i) => {
        gsap.to(el, {
          scrollTrigger: { trigger: '#fgm', start: 'top 80%' },
      ...
      <section id="hero">
        ...
        <div className="hero-bg-frames" id="hero-bg-frames">
          <div className="hbf-card hbf-doc hbf-c1">
            <div className="hbf-doc-top"><span>Q4 Tax Report</span><span style={{ fontFamily: 'var(--sans)', fontSize: '12px', color: 'rgba(255,255,255,0.4)', }}>2hr</span></div>
          ...
          <div className="hbf-card hbf-c2">
            <div className="hbf-folder-icon">📁</div>
          </div>
          <div className="hbf-card hbf-doc hbf-c3">
            <div className="hbf-doc-top"><span>Client Contract</span><span style={{ fontFamily: 'var(--sans)', fontSize: '12px', color: 'rgba(255,255,255,0.4)', }}>1d</span></div>
            <div className="hbf-doc-body">
          ...
          <div className="hbf-card hbf-c4">
            <div className="hbf-folder-icon">📁</div><div className="hbf-badge" style={{ background: 'transparent', color: 'rgba(255,255,255,0.4)', }}>5hr</div>
          </div>
          <div className="hbf-card hbf-c5">
            <div className="hbf-doc-top"><span>Newsletter Draft</span><span style={{ fontFamily: 'var(--sans)', fontSize: '12px', color: 'rgba(255,255,255,0.4)', }}>5hr</span></div>
            <div className="hbf-doc-body">
      ...
      <section id="solution">
        <div className="solution-card" id="solution-card">
          ...
          <div className="solution-cta-area">
            <a href="#" className="btn-outline-white">Create Your Free Account</a>
          </div>
            ...
            <div className="marquee-track">
              <div className="marquee-inner" id="marquee-inner">
                {[
                  ...
                  { name: 'Zoho', text: 'ZOHO', color: '#00539c' },
                  { name: 'Tally', text: 'Tally', color: '#002E5A' },
        ...
        <div className="pricing-inner">
          ...
          <div className="pricing-grid" id="pricing-grid">
            <div className="price-card" data-delay="0">
              ...
              <button className="pc-cta pc-cta-dark">Get Started Free</button>
            ...
            <div className="price-card featured" data-delay="80">
              ...
              <button className="pc-cta pc-cta-green">Start Pro Free →</button>
              <div className="pc-divider"></div>
              <ul className="pc-features">
